...
require (
	github.com/UpCloudLtd/upcloud-go-sdk v0.0.0-20170522140651-a308c4efe392
	github.com/blang/semver v3.3.0+incompatible // indirect
	...
	github.com/mitchellh/packer v0.10.2
